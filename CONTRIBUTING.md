...
* In Github, fork `https://github.com/eyetowers/gowsdl` to your own account
* Get the package using "go get": `go get github.com/eyetowers/gowsdl`
* Move to where the package was cloned: `cd $GOPATH/src/github.com/eyetowers/gowsdl/`
